...
var init = async () => {
    ...
    //3. compress all files using ffmpeg. If a file is already compressed do not compress it agin.
    //4. generate manifest. it will gerneate .mpd + .mp4 files.
    //5. delete compressed files generated by ffmpg.
